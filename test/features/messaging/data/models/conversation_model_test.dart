  ...
  group('ConversationModel', () {
    group('fromJson', () {
      ...
      test('reads avatar from profile_picture field', () {
        final model = ConversationModel.fromJson(_buildJson(
          participant: {
            'id': 'user-2',
            'display_name': 'Alice',
      ...
      test('falls back to avatar field when profile_picture and avatar_url absent', () {
        final model = ConversationModel.fromJson(_buildJson(
          participant: {
            'id': 'user-2',
            'display_name': 'Alice',
      ...
      test('uses body as lastMessagePreview when present', () {
        final model = ConversationModel.fromJson(_buildJson(
          lastMessage: {'body': 'Check this out', 'created_at': '2024-06-01T12:00:00.000Z'},
        ));
      ...
      test('uses track URL when embed_type is track', () {
        ...
        expect(model.lastMessagePreview, 'https://rythmify.com/tracks/track-999');
      });
      ...
      test('uses playlist URL when embed_type is playlist', () {
        ...
        expect(model.lastMessagePreview, 'https://rythmify.com/playlists/pl-111');
      });
      ...
      test('uses playlist URL when embed_type is album', () {
        ...
        expect(model.lastMessagePreview, 'https://rythmify.com/playlists/alb-222');
      });

      test('defaults lastMessagePreview to empty when no body or embed', () {
        final model = ConversationModel.fromJson(_buildJson(
          lastMessage: {'created_at': '2024-06-01T12:00:00.000Z'},
        ));
    ...
    group('toJson', () {
      test('serializes all fields correctly', () {
        ...
        expect(participant['profile_picture'], 'https://example.com/avatar.png');
