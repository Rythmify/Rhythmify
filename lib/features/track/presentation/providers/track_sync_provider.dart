...
class TrackSyncNotifier extends Notifier<Map<String, Track>> {
  ...
  void toggleRepost(String trackId, bool isCurrentlyReposted, Track? currentTrack) {
    final track = state[trackId] ?? currentTrack;
    if (track == null) return;
...
final trackSyncProvider = NotifierProvider<TrackSyncNotifier, Map<String, Track>>(() {
