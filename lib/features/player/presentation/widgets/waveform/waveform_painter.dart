...
class WaveformPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double activeProgress =
        activePosition.inMilliseconds / duration.inMilliseconds;
    final double activeOffset = activeProgress * totalWaveWidth;

    final double actualProgress =
        actualPosition.inMilliseconds / duration.inMilliseconds;
    ...
    for (int i = 0; i < amplitudes.length; i++) {
      ...
      final double topHeight = math.max(
        1.0,
        baseAmplitude * maxHeight * heightMultiplier,
      );
