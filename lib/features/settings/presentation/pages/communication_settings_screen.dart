          ...
          body: Column(
            children: [
              ReusableTileWidget(
                ...
                title: 'Personalise news, tips, and offers for SoundCloud products',
                subtitle: 'If you turn this setting off, the communications you\'ll see may be less relevant',
                switchExists: true,
