...
class PushNotificationService{
    ...
    void _handleForegroundmessages(){
        FirebaseMessaging.onMessage.listen((message){
            print('📩 [PUSH] foreground message received: title="${message.notification?.title}" data=${message.data}');
    ...
    void _handleMessageOpenApp(){
        FirebaseMessaging.onMessageOpenedApp.listen((message){
            print('👆 [PUSH] notification tapped (app was background): data=${message.data}');
    ...
    void _navigateByType({
        ...
        print('🧭 [PUSH] navigating — type=$type resourceType=$resourceType resourceId=$resourceId');
