...
class SearchConversationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      key: Key(
        'messaging_search_conversation_item_${participantName}_list_tile',
      ),
      onTap: onTap,
      ...
      title: Text(
        participantName,
        key: Key(
          'messaging_search_conversation_item_${participantName}_name_text',
        ),
        ...
        children: [
          if (participantCountry != null)
            Text(
              participantCountry!,
              key: Key(
                'messaging_search_conversation_item_${participantName}_country_text',
              ),
          ...
          Row(
            children: [
              ...
              Text(
                ...
                key: Key(
                  'messaging_search_conversation_item_${participantName}_followers_text',
                ),
                style: MessagingThemes.searchPCountry,
              ),
            ],
      ...
      trailing: SearchMessageWidget(
        key: Key(
          'messaging_search_conversation_item_${participantName}_Message_button',
        ),
        onPressed: onTap,
      ),
    );
